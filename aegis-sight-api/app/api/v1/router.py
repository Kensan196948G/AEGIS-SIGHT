...
TAG_METADATA: list[dict] = [
    ...
    },
    {
        ...
        "description": (
            ...
            "Manage DLP rules for file operation monitoring. Evaluate file operations "
            "against rules to detect and prevent data leakage via USB, email, or "
    ...
    },
    {
        ...
        "description": (
            "**Print management.** "
            "Register printers, record print jobs, view print statistics, "
            "manage print policies, and evaluate jobs against policies "
            "before execution."
        ),
    },
    {
